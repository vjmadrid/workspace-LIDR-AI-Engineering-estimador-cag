#!/bin/bash
# Script para probar el endpoint LiteLLM de estimación de la API local.
# Uso: ./scripts/run_estimate_llmlite_example.sh

API_URL="${API_URL:-http://127.0.0.1:8000/api/v1/estimate/llmlite}"
