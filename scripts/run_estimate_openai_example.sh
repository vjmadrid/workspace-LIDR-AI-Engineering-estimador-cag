#!/bin/bash
# Script para probar el endpoint OpenAI de estimación de la API local.
# Uso: ./scripts/run_estimate_openai_example.sh

API_URL="${API_URL:-http://127.0.0.1:8000/api/v1/estimate/openai}"
